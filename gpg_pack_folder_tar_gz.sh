...
Compress folder to tar.gz archive and encrypt
...
#<hb>***************************************************************************
#
# gpg_pack_folder_tar_gz.sh <source_folder> [<output_file>]
#
# source_folder       - folder to pack
#
# output_file         - potional archive name
#
# Example: ./gpg_pack_folder_tar_gz.sh /folder/name output.tar.gz.gpg
#
#<he>***************************************************************************
